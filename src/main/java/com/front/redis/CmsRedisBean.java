...
public class CmsRedisBean {

	private List<CmsRedisInfo>redisInfos;
	...
	public void setRedisInfos(List<CmsRedisInfo> redisInfos) {
		this.redisInfos = redisInfos;
	}
	
	public List<CmsRedisInfo> getRedisInfos() {
		return redisInfos;
	}
